...
BRITTLE_NETS = ['resnet18', 'mobilenet', 'VGG16', 'alexnet']  # handled with lower learning rate
...
def training_strategy(model_name, args):
    ...
    elif args.optimization == 'sponge':
        defaults = SPONGE
    elif args.optimization == 'sponge_exponential':
        defaults = SPONGE_EXPONENTIAL
    ...
    defs.adaptive_attack = args.adaptive_attack
...
SPONGE_EXPONENTIAL = Hyperparameters(
    name='sponge_exponential',
    lr=0.1,
    epochs=100,
    batch_size=512,
    optimizer='SGD',
